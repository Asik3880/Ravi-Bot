...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, SUPPORT_CHAT_ID, CUSTOM_FILE_CAPTION, MSG_ALRT, PICS, AUTH_GROUPS, P_TTI_SHOW_OFF, GRP_LNK, CHNL_LNK, SPRT_CHNL, NOR_IMG, LOG_CHANNEL, SPELL_IMG, MAX_B_TN, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, NO_RESULTS_MSG, TUTORIAL, HOW_TO_VERIFY, REQST_CHANNEL, IS_TUTORIAL, LANGUAGES, SEASONS, QUALITY, SEARCH, SUPPORT_CHAT, PREMIUM_USER
    ...
    if settings['button']:
        ...
        btn.insert(0, 
            [
                ...
                InlineKeyboardButton(f'ʀᴜʟᴇꜱ', 'search')
            ]
        )
        # btn.insert(0, [
