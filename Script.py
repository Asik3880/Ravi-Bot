...
✭ Bᴏᴛ ɪs Rᴇᴅᴇsɪɢɴ ʙʏ <a href='https://t.me/Filmymod7'>Filmymod Owner</a>
...
/setshortlinkon - Tᴏ Sᴇᴛ Sʜᴏʀᴛɴᴇʀ Oɴ
/setshortlinkoff - Tᴏ Sᴇᴛ Sʜᴏʀᴛɴᴇʀ Oғғ
...
👉/set_tutorial https://t.me/Filmymod123 </b>"""
...
𝗠𝗢𝗩𝗜𝗘 𝗜𝗦 𝗡𝗢𝗧 𝗔𝗩𝗔𝗜𝗟𝗔𝗕𝗟𝗘 𝗜𝗡 𝗧𝗛𝗘 𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘 𝗥𝗘𝗣𝗢𝗥𝗧 𝗧𝗢 𝗔𝗗𝗠𝗜𝗡 👇"""
    ...
    SHORTLINK_INFO = """
<b>─────「<a href=https://t.me/Filmymod123> Hᴏᴡ ᴛᴏ Eᴀʀɴ Mᴏɴᴇʏ </a> 」─────
...
sᴛᴇᴘ 𝟸 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ Aɴʏ <a href=https://urlshortx.com/>Sʜᴏʀᴛᴇɴᴇʀ Wᴇʙsɪᴛᴇ</a>.

sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href=https://t.me/Filmymod123> ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ </a>Tᴏ ᴄᴏɴɴᴇᴄᴛ sʜᴏʀᴛᴇɴᴇʀ.
...
ɪꜰ ʏᴏᴜ ᴅᴏ ɴᴏᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ / sᴇʀɪᴇs ꜰɪʟᴇ, ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ"""
    ...
    SELECT = """
𝐅𝐨𝐫 𝐌𝐎𝐕𝐈𝐄𝐒 ➢ Sᴇʟᴇᴄᴛ "❍ ʟᴀɴɢᴜᴀɢᴇꜱ ❍"

𝐅𝐨𝐫 𝐒𝐄𝐑𝐈𝐄𝐒 ➢ Sᴇʟᴇᴄᴛ "✪ Sᴇᴀꜱᴏɴꜱ ✪"

Tɪᴘ: Sᴇʟᴇᴄᴛ "Lᴀɴɢᴜᴀɢᴇs" ᴏʀ "Sᴇᴀsᴏɴs" Bᴜᴛᴛᴏɴ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ᴅᴇsɪʀᴇ."""
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)"""
    ...
    SJOIN = """
    ⚠️𝐑𝐞𝐚𝐝 𝐂𝐚𝐫𝐞𝐟𝐮𝐥𝐥𝐲⚠️
Iғ Bᴏᴛ ᴏʀ Gʀᴏᴜᴘ Gᴏᴛ Bᴀɴ Fʀᴏᴍ Cᴏᴘʏʀɪɢʜᴛs Tʜᴇɴ Yᴏᴜ Wɪʟʟ Gᴇᴛ Tʜᴇ Nᴇᴡ Oɴᴇ Fʀᴏᴍ Tʜᴀᴛ Cʜᴀɴɴᴇʟ."""
...
•─────────★•♛•★────────•</b>""" 
    ...
    FORCE_SUB = """<b>**   ⚠️ Pʟᴇᴀsᴇ Fᴏʟʟᴏᴡ Tʜɪs Rᴜʟe ⚠️

ᴘʟᴇᴀꜱᴇ ♻️ ᴊᴏɪɴ ᴍʏ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ♻️ ꜰɪʀꜱᴛ, ᴛʜᴇɴ ᴄᴏᴍᴇ ʙᴀᴄᴋ ʜᴇʀᴇ ᴀɴᴅ ᴄʟɪᴄᴋ 🔄 ᴛʀʏ ᴀɢᴀɪɴ ʙᴜᴛᴛᴏɴ

ᴘʜᴇʟᴇ ᴍᴇʀᴇ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ ᴍᴇ ᴊᴏɪɴ ʜᴏ ᴊᴀᴏ ᴜꜱᴋᴇ ʙᴀᴀᴅ ᴛʀʏ ᴀɢᴀɪɴ ʙᴜᴛᴛᴏɴ ᴘᴇ ᴄʟɪᴄᴋ ᴋᴀʀᴏ ☟**</b>"""
...
<b>┏━•❃𓊈Oᴡɴᴇʀ Dᴇᴛᴀɪʟꜱ𓊉❃•━┓   
 ◈ ᴛɢ ɴᴀᴍᴇ : 𝗙𝗶𝗹𝗺𝘆𝗺𝗼𝗱
 ◈ ᴜꜱᴇʀɴᴀᴍᴇ : @Filmymod7
 ◈ ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href='t.me/Filmymod7'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>
‿︵‿︵‿︵‿୨❤୧‿︵‿︵‿︵‿"""
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='t.me/Filmymod7'>𝗙𝗶𝗹𝗺𝘆𝗺𝗼𝗱</a></b>"""
