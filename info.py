...
API_ID = int(environ.get('API_ID', '27846542'))
API_HASH = environ.get('API_HASH', '75be2951252a1616bcf31aa45bf62d24')
BOT_TOKEN = environ.get('BOT_TOKEN', "6171533529:AAFRc6Sv87_EOjxMGrBI_ace4zkB1_DJtLM")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1053777957').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
# auth_channel = environ.get('AUTH_CHANNEL','-1001508034714')
auth_channel = environ.get('AUTH_CHANNEL','-1001508034714,-1001733285589')
auth_grp = environ.get('AUTH_GROUP')
# AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_CHANNEL = [int(ch) for ch in auth_channel.split()] if auth_channel and id_pattern.search(auth_channel) else []
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://spidy:MongoDB1432@cluster1.ssqidl2.mongodb.net/?retryWrites=true&w=majority")
...
SPRT_CHNL = environ.get('SPRT_CHNL', 'https://t.me/Filmymod_Support')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Filmymod123')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Download_Movies321/14')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/How_To_Download_Movies321/14')
